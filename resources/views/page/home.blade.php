        ...
        <div class="row g-2 rtl-flex-d-row-r">
          ...
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/woman-clothes.png" alt=""><span>Women's Fashion</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/grocery.png" alt=""><span>Groceries &amp; Pets</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/shampoo.png" alt=""><span>Health &amp; Beauty</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/rowboat.png" alt=""><span>Sports &amp; Outdoors</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/tv-table.png" alt=""><span>Home Appliance</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/beach.png" alt=""><span>Tour &amp; Travels</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/baby-products.png" alt=""><span>Mother &amp; Baby</span></a></div>
            </div>
          </div>
          <!-- Catagory Card -->
          <div class="col-3">
            <div class="card catagory-card active">
              <div class="card-body px-2"><a href="catagory.html"><img src="{{asset('suha')}}/img/core-img/price-tag.png" alt=""><span>Clearance Sale</span></a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="flash-sale-slide owl-carousel">
          ...
          <div class="card flash-sale-card">
            <div class="card-body"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/1.png" alt=""><span class="product-title">Black Table Lamp</span>
          ...
          <!-- Flash Sale Card -->
          <div class="card flash-sale-card">
            <div class="card-body"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/2.png" alt=""><span class="product-title">Modern Sofa</span>
          ...
          <!-- Flash Sale Card -->
          <div class="card flash-sale-card">
            <div class="card-body"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/3.png" alt=""><span class="product-title">Classic Garden Chair</span>
              ...
              <div class="card featured-product-card">
                <div class="card-body">
                  ...
                  <div class="product-thumbnail-side">
                    <!-- Thumbnail --><a class="product-thumbnail d-block" href="javascript:void(0)"><img loading="lazy" src="https://admin.kebabyasmin.id/{{ $t->foto }}" alt=""></a>
                  </div>
                  <div class="product-description">
                    <!-- Product Title --><a class="product-title d-block" style="font-size: 8px;" href="javascript:void(0)">{{ $t->nm_produk }}</a>
                    <!-- Price -->
                    {{-- <p class="sale-price">$39<span>$89</span></p> --}}
                    <p class="sale-price" style="font-size: 12px;">Rp.{{ number_format($t->harga,0) }}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-2">
          ...
          <div class="col-12">
            <div class="card horizontal-product-card">
              <div class="d-flex align-items-center">
                <div class="product-thumbnail-side">
                  <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img src="{{asset('suha')}}/img/product/18.png" alt=""></a>
          ...
          <div class="col-12">
            <div class="card horizontal-product-card">
              <div class="d-flex align-items-center">
                <div class="product-thumbnail-side">
                  <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img src="{{asset('suha')}}/img/product/7.png" alt=""></a>
                  <!-- Wishlist  --><a class="wishlist-btn" href="#"><i class="ti ti-heart"></i></a>
                </div>
                <div class="product-description">
          ...
          <div class="col-12">
            <div class="card horizontal-product-card">
              <div class="d-flex align-items-center">
                <div class="product-thumbnail-side">
                  <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img src="{{asset('suha')}}/img/product/12.png" alt=""></a>
                  <!-- Wishlist  --><a class="wishlist-btn" href="#"><i class="ti ti-heart"></i></a>
                </div>
                <div class="product-description">
          ...
          <div class="col-12">
            <div class="card horizontal-product-card">
              <div class="d-flex align-items-center">
                <div class="product-thumbnail-side">
                  <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img src="{{asset('suha')}}/img/product/17.png" alt=""></a>
                  <!-- Wishlist  --><a class="wishlist-btn" href="#"><i class="ti ti-heart"></i></a>
                </div>
                <div class="product-description">
              ...
              <div class="col-4 col-md-4 box all {{ $p->kategori_id }}">
                  <div class="card product-card">
                    <div class="card-body">
                      ...
                      <!-- Product Title --><a class="product-title demoname" href="javascript:void(0)" style="font-size: 8px;">{{ $p->nm_produk }}</a>
                      <!-- Product Price -->
    ...
    {{-- <div class="pb-3">
      <div class="container">
        ...
        <div class="collection-slide owl-carousel">
          <!-- Collection Card-->
          <div class="card collection-card"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/17.jpg" alt=""></a>
            <div class="collection-title"><span>Women</span><span class="badge bg-danger">9</span></div>
          </div>
          <!-- Collection Card-->
          <div class="card collection-card"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/19.jpg" alt=""></a>
            <div class="collection-title"><span>Men</span><span class="badge bg-danger">29</span></div>
          </div>
          <!-- Collection Card-->
          <div class="card collection-card"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/21.jpg" alt=""></a>
            <div class="collection-title"><span>Kids</span><span class="badge bg-danger">4</span></div>
          </div>
          <!-- Collection Card-->
          <div class="card collection-card"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/22.jpg" alt=""></a>
            <div class="collection-title"><span>Gadget</span><span class="badge bg-danger">11</span></div>
          </div>
          <!-- Collection Card-->
          <div class="card collection-card"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/23.jpg" alt=""></a>
            <div class="collection-title"><span>Foods</span><span class="badge bg-danger">2</span></div>
          </div>
          <!-- Collection Card-->
          <div class="card collection-card"><a href="single-product.html"><img src="{{asset('suha')}}/img/product/24.jpg" alt=""></a>
